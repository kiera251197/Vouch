...
error_reporting(E_ALL);
    ...
    echo "<h1 style='color: pink;'>This is the dashboardSingle.php page.
    <br> I am trying my best for this to be done :')</h1>";
?>
...
<head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="dashboardSingle.css">
</head>
